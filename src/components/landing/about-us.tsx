...
export default function AboutUs() {
	...
	return (
		<SectionLayout fullWidth id="about-us" noPadding className="bg-primary/30 p-4 md:p-10 md:min-h-screen">
			<div className="relative flex flex-col md:flex-row h-full w-full justify-between">
				...
				<p ref={container} className="flex flex-wrap text-lg sm:text-2xl md:text-4xl lg:text-6xl p-2 md:p-10 h-full w-full md:w-1/2">
					{words.map((word, i) => {
