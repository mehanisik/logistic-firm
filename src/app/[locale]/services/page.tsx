	...
	const services = [
		{
			...
			features: [t("features.freight-forwarding.badge"), t("features.freight-forwarding.cta"), t("features.freight-forwarding.altText")],
		},
		{
			icon: IconPlane,
			title: t("features.track-shipment.name"),
			description: t("features.track-shipment.description"),
			features: [t("features.track-shipment.badge"), t("features.track-shipment.cta"), t("features.track-shipment.altText")],
		},
		{
			icon: IconTruck,
			title: t("features.project-cargo.name"),
			description: t("features.project-cargo.description"),
			features: [t("features.project-cargo.badge"), t("features.project-cargo.cta"), t("features.project-cargo.altText")],
		},
		{
			icon: IconFileText,
			title: t("features.customs-brokerage.name"),
			description: t("features.customs-brokerage.description"),
			features: [t("features.customs-brokerage.badge"), t("features.customs-brokerage.cta"), t("features.customs-brokerage.altText")],
		},
		{
			icon: IconBuildingWarehouse,
			title: t("features.warehousing.name"),
			description: t("features.warehousing.description"),
			features: [t("features.warehousing.badge"), t("features.warehousing.cta"), t("features.warehousing.altText")],
		},
		{
			icon: IconShield,
			title: t("headline"),
			...
			<div className="w-full h-full py-10">
				<section className="pt-20 pb-10 px-4 max-w-7xl mx-auto">
					<div className="text-center mb-16">
						...
						<h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-8">{t("headline")}</h1>
