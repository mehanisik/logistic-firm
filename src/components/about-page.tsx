...
import { IconArrowRight, IconCircleCheck, IconGlobe, IconShip, IconTrendingUp, IconUsers } from "@tabler/icons-react"
...
export default function AboutUs() {
	...
	const stats = [
		{ icon: IconGlobe, value: t3("stat3Value"), label: t3("stat3Label"), description: t3("breakoutDescription") },
		{ icon: IconShip, value: t3("stat1Value"), label: t3("stat1Label"), description: t3("mainImageAlt") },
		{ icon: IconUsers, value: t3("stat2Value"), label: t3("stat2Label"), description: t3("secondaryImageAlt") },
		{ icon: IconTrendingUp, value: t3("stat4Value"), label: t3("stat4Label"), description: t3("breakoutAlt") },
	]
			...
			<div className="grid lg:grid-cols-2 gap-12 mb-16">
				<Card>
					...
					<CardContent className="space-y-6">
						<p className="text-muted-foreground leading-relaxed">{t("ourStoryText")}</p>
