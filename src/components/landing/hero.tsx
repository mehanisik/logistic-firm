...
export default function Hero() {
	...
	return (
		<>
			<Navbar />
			<section id="hero" className="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden p-0 m-0">
				<div
					aria-hidden="true"
					role="presentation"
				...
				<div className="relative z-10 w-full flex justify-center items-center px-4 py-8">
					<div className="max-w-3xl w-full p-8 md:p-12 flex flex-col items-center gap-6 rounded-lg bg-background/80 backdrop-blur-sm md:bg-transparent md:backdrop-blur-none">
						...
						<p className="text-lg leading-relaxed text-center text-muted-foreground">{t("description")}</p>
