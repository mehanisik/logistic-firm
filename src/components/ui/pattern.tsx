  ...
  return (
    <div
      ...
      style={{
        ...
        maskImage: 'radial-gradient(ellipse 75% 55% at 50% 50%, black 40%, transparent 85%)',
        WebkitMaskImage: 'radial-gradient(ellipse 75% 55% at 50% 50%, black 40%, transparent 85%)',
        ...darkModeStyles,
      }}
    />
  );
