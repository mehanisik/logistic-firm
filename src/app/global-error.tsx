...
const messages = {
	...
	tr: {
		...
		description: "Rahatsızlık için özür dileriz. Kritik bir hata oluştu. Ekibimiz bilgilendirildi ve sorunu çözmek için çalışıyor.",
		...
		<html lang={locale} suppressHydrationWarning className={theme}>
			<body className="min-h-screen bg-background text-foreground">
				<div className="flex flex-col items-center justify-center min-h-screen px-4 text-center">
					...
					<h1 className="mb-2 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">{t.title}</h1>
					...
					<div className="flex flex-col gap-4 sm:flex-row">
						...
						<Button variant="outline" asChild>
							<a href={`/${locale}`} className="inline-flex items-center justify-center">
								{t.returnHome}
							</a>
						</Button>
					</div>
